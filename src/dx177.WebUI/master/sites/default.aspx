<%@ Page Language="C#" MasterPageFile="~/master/Site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="dx177.WebUI.master.sites._default" Title="Untitled Page" %>
                ...
                <div class="info_pic">
                    <ul>
                        <asp:ListView ID="lsQuestion" runat="server" OnItemDataBound="LsHotelList_ItemDataBound"
                            ...
                            <ItemTemplate>                                
                                    <li><a href="/html/<%# DataBinder.Eval(Container.DataItem, "matchdomain")%>/Sites_<%# DataBinder.Eval(Container.DataItem, "seqno")%>.html" target="_blank" title="<%# DataBinder.Eval(Container.DataItem, "title")%>">
