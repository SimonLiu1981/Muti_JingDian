<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SettingSendmail.aspx.cs" Inherits="dx177.WebUI.admin.SendMail.SettingSendmail" %>
        ...
        <tr>
            <td>
                <div class="div_subtitle">
                    当前位置：邮件设置<span class="arrow_subtitle">&gt;邮件设置</span></div>
            </td>
        </tr>
    </table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="td_title" width="15%">
                                                &nbsp;邮箱：</td>
                                            <td>
                                                <asp:TextBox ID="txtMail" runat="server" Width="358px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="td_title" width="15%">
                                                密码</td>
                                            <td>
                                                <asp:TextBox ID="txtpasswword" runat="server" Width="358px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="td_title" width="15%">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtsmtp" runat="server" Width="358px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="td_title" width="15%">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtmail1" runat="server" Width="358px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="td_title" width="15%">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtmail2" runat="server" Width="358px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
