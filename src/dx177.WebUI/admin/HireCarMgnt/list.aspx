<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="dx177.WebUI.admin.HireCarMgnt.list" %>
                ...
                <td>
                    ...
                    <cc1:ZteGrid ID="dgNews" runat="server" Style="margin-top: 5px" CssClass="tb_datalist1"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="Range" HeaderText="范围"></asp:BoundColumn>
                            <asp:BoundColumn DataField="TelNumber" HeaderText="联系电话"></asp:BoundColumn>
                            <asp:BoundColumn DataField="CarType" HeaderText="车型"></asp:BoundColumn>                            
                             <asp:TemplateColumn>
                                <HeaderStyle Width="150px" />
                                <HeaderTemplate>
                                     状态
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="btnDelete" runat="server" CommandName="Delete" OnClientClick="return confirm('确认删除该饭店吗？')"  CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Seqno") %>'>删除</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
