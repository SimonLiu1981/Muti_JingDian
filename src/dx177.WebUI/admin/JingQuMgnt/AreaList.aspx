<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AreaList.aspx.cs" Inherits="dx177.WebUI.admin.JingQuMgnt.AreaList" %>
            ...
            <tr>
                <td>
                    <cc1:ZteGrid ID="dgNews" runat="server" Style="margin-top: 5px" CssClass="tb_datalist1"
                        ...
                        <Columns>
                            <asp:BoundColumn Visible="False" DataField="JingQuAreaId" HeaderText="JingQuAreaId"></asp:BoundColumn>                             
                            <asp:BoundColumn DataField="AreaName" HeaderText="区域名"></asp:BoundColumn>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnModify" runat="server" CommandName="Modify" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "JingQuAreaId") %>'>修改</asp:LinkButton>
                                    <asp:LinkButton ID="btnDelete" runat="server" CommandName="Delete" OnClientClick='return confirm("是否删除景区？")'
                                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "JingQuAreaId") %>'>删除</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="td_title" width="15%">
                                                &nbsp;景区名<asp:HiddenField ID="txtJingQuID" runat="server" />
                                            </td>
                                            <td>
