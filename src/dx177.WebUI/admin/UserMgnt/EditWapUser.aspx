<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditWapUser.aspx.cs" Inherits="dx177.WebUI.admin.UserMgnt.EditWapUser" %>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td class="td_title" width="15%">
                                            类型：</td>
                                        <td colspan="1">
                                            <asp:RadioButtonList ID="rbtIssubdomain" runat="server" 
                                                RepeatDirection="Horizontal">
                                                <asp:ListItem Selected="True" Value="0">非子域名</asp:ListItem>
                                                <asp:ListItem Value="1">子域名</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                        <td class="td_title" width="15%">
                                            代号：                                         </td>
                                        <td colspan="1">
                                            <asp:TextBox ID="txtDomainname" runat="server" Width=127px  ></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="td_title" width="15%">
