<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JingQuManagerList.aspx.cs" Inherits="dx177.WebUI.admin.UserMgnt.JingQuManagerList" %>
                    ...
                    <cc1:ZteGrid ID="dgWapUserlist" runat="server" Style="margin-top: 5px" CssClass="tb_datalist1"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="Phone" HeaderText="电话"></asp:BoundColumn>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblManageJingQu" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "JingQucode") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn> 
                            <asp:TemplateColumn>
