<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteList.aspx.cs" Inherits="dx177.WebUI.admin.SiteMgnt.SiteList" %>
        ...
        <tr>
            <td>
                <div class="div_subtitle">
                    当前位置：图片欣赏管理<span class="arrow_subtitle">&gt;</span>图片欣赏列表</div>
            </td>
        </tr>
    </table>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <cc1:ZteGrid ID="dgSites" runat="server" Style="margin-top: 5px" CssClass="tb_datalist1"
                        ...
                        BorderStyle="Solid" OnItemDataBound="dgSites_ItemDataBound" 
                        OnItemCommand="dgSites_ItemCommand">
