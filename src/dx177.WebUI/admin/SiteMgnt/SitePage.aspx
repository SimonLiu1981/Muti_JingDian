<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="SitePage.aspx.cs"
    Inherits="dx177.WebUI.admin.SiteMgnt.SitePage" %>
                                ...
                                <table class="tb_input" id="queryPane" cellspacing="1" cellpadding="0" width="100%"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <uc3:UCModelType ID="UCModelType1" runat="server" Type="Sites" />
                                            </td>
                                            <td class="td_title" width="15%">
                                                最后更新时间
                                            </td>
