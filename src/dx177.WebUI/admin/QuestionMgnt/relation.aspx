<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="relation.aspx.cs" Inherits="dx177.WebUI.admin.QuestionMgnt.relation" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function CollectionGUIDs() {
            if ($('input[Rguid][checked]').length > 0) {
                $('input[Rguid][value=on]').each(function() {
                    var allguids = '';
                    allguids += $(this).attr("Rguid") + ',';
                    $('#txtRelateGuids').val(allguids);
                });
                ...
                <td>
                    <table class="tb_input" id="queryPane" cellspacing="1" cellpadding="0" width="100%"
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                 <asp:HiddenField ID="txtOriginalGuid" runat="server" />
                                     <ul class=RelateClass>
                                         <asp:Repeater ID="Repeater1" runat="server">
                                            <ItemTemplate>
                                                <li><input type="checkbox" Rguid = "<%# DataBinder.Eval(Container.DataItem, "Guid") %>" /> <%# DataBinder.Eval(Container.DataItem, "Title") %> </li>    
                                            </ItemTemplate>
                                         </asp:Repeater>                                        
                                     </ul>                                    
                                 
                                <asp:HiddenField ID="txtRelateGuids" runat="server" />
                                <asp:Button ID="btnDelSelectQuestion" runat="server" 
                                    OnClientClick="return CollectionGUIDs()" Text="删除选中问题" 
                                    onclick="btnDelSelectQuestion_Click" />
                            </td>
                        </tr>
                    ...
                    <table class="tb_searchbar" cellspacing="1" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <td align="left">
                                    <asp:Button ID="btnAddRalte" runat="server" Text="增加到关联" CssClass="button4" OnClick="bntAddRelation_Click">
                                    </asp:Button>
                                </td>
                                <td align="right" colspan="3">
                                    <asp:Button ID="btnSearch" runat="server" Text="查询" CssClass="button" OnClick="btnSearch_Click">
                                    </asp:Button>
                                    <asp:Button ID="btnReturn" runat="server" Text="返回" CssClass="button" 
                                        OnClick="btnReturn_Click" Height="24px">
                                    </asp:Button>
                                </td>
                            </tr>
                        </tbody>
