<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="QsttypeTree.aspx.cs" Inherits="dx177.WebUI.admin.QuestionMgnt.QsttypeTree" %>
                    ...
                    <table id="Table1" width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            <td align="left" colspan="2" style="padding: 5px 2px;">
                                ...
                                <font color="red"><strong>选择选中问题类型，鼠标右键进行编辑！</strong> </font>
                            </td>
                        </tr>
                        <tr>
