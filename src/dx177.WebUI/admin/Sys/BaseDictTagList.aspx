<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaseDictTagList.aspx.cs" Inherits="dx177.WebUI.admin.Sys.BaseDictTagList" %>
                    ...
                    <cc1:ZteGrid ID="dgData" runat="server" Style="margin-top: 5px" CssClass="tb_datalist1"
                        ...
                        <Columns>
                            <asp:BoundColumn Visible="False" DataField="Seqno" HeaderText="Seqno"></asp:BoundColumn>                            
                              ...
                              <asp:BoundColumn   DataField="Seqno" HeaderText="Seqno"></asp:BoundColumn>                            
