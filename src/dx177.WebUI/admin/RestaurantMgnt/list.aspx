<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="dx177.WebUI.admin.RestaurantMgnt.list" %>
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="Title" HeaderText="标题"></asp:BoundColumn>
                             <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblRestaurantType" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "RestaurantType") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                             <asp:TemplateColumn>
                                <HeaderStyle Width="150px" />
