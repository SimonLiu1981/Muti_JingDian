<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Productlist.aspx.cs" Inherits="dx177.WebUI.admin.productMgnt.Productlist" %>
        ...
        <tr>
            <td>
                <div class="div_subtitle">
                    当前位置：产品管理<span class="arrow_subtitle">&gt;</span>产品列表</div>
            </td>
        </tr>
    </table>
                ...
                <td>
                    ...
                    <cc1:ZteGrid ID="dgNews" runat="server" Style="margin-top: 5px" CssClass="tb_datalist1"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="nowprice" HeaderText="现价"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ViewTimes" HeaderText="浏览次数"></asp:BoundColumn>
