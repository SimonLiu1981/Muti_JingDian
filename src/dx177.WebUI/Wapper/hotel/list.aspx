<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="dx177.WebUI.Wapper.hotel.list"
...
<asp:Content ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InitSection() {
            //class="sx_curr"
            var cur = '<%=this.price %>';
            if ($('A[price=' + cur + ']').length > 0) {
                $($('A[price=' + cur + ']')[0]).addClass("sx_curr");
            }
            else {
                $($('A[price=\'0\']')[0]).addClass("sx_curr");
            }
            cur = '<%=this.HotelType %>';
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="nav_son">
        <span><a href="/web/hotelorder/orderlist.aspx" class="cxdd">查询我的订单状态</a></span>当前位置：<a
            href="/index.html">首页</a> &gt;&nbsp;<%=jingquName%>酒店预订</div>
    <div id="mainContent">
        <div id="side">
                        ...
                        <div class="list_box div0">
                            <div class="lb_pic">
                                <dl>
                                    ...
                                    <dd>
                                        <a href="/hotel_list_type6_1.html">
