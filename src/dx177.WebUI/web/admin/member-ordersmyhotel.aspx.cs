...
{
    public partial class member_ordersmyhotel : ResUserBasePage
    {
        ...
        private void InitDataSearch()
        {
            ...
            Hotel h = HotelBLL.GetInstance().GetHotelByUser(AppContext.CurrentResuser.Username);
            query.HotelSeqno = h.Seqno.ToString();
