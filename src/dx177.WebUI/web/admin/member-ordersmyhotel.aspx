<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="member-ordersmyhotel.aspx.cs" Inherits="dx177.WebUI.web.admin.member_ordersmyhotel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ModifyHotelOrder(seqno) {
            var url = "/member-ManagerMyHotelOrder.aspx?seqno=" + seqno + "&TB_iframe=true&height=400&width=820&modal=true";
            ShowPopup(url);
        }
        function RefashData() {
        ...
        <div class="MemberCenter">
            ...
            <div class="MemberSidebar">
                <div class="MemberMenu">
                    ...
                    <div class="body">
                        <uc1:UCLeftMenu ID="UCLeftMenu1" CurrentMenuID="menu_ordermyhotel" runat="server" />
                    </div>
                    <div class="foot">
                    </div>
                </div>
                    ...
                    <div class="order_title_div">
                        <table border='0' cellspacing="0" cellpadding="0" width="250">
                            <tbody>
                                <tr id='ordre_head_tr'>
                                    <td id='ptd_0'>
                                        <a href="/member-ordersmyhotel.aspx">全部订单</a>
                                    </td>
                                    <td id='ptd_1'>
                                        <a href="/member-ordersmyhotel.aspx?status=1">已经取消</a>
                                    </td>
                                    <td id='ptd_2'>
                                        <a href="/member-ordersmyhotel.aspx?status=2">等待确认</a>
                                    </td>
                                    <td id='ptd_3'>
                                        <a href="/member-ordersmyhotel.aspx?status=3">已经确认</a>
                                    </td>
                                    <td id='ptd_4'>
                                        <a href="/member-ordersmyhotel.aspx?status=4">已经入住</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <asp:ListView ID="lvOrder" runat="server" OnPagePropertiesChanging="lvOrder_PagePropertiesChanging">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td> 
                                                <a href="javascript:;" onclick='ModifyHotelOrder("<%# DataBinder.Eval(Container.DataItem, "Seqno") %>")' ><%# dx177.Business.DictBus.Dict.Tag[(dx177.FrameWork.HotelOrderStatus)int.Parse(DataBinder.Eval(Container.DataItem,"status").ToString())] %></a>                                            
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:ListView>
