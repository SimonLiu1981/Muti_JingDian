<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true"
    CodeBehind="member-Restaurantlist.aspx.cs" Inherits="dx177.WebUI.web.admin.member_publish_Restaurantlist" %>
        ...
        <div class="MemberCenter">
            ...
            <div class="MemberSidebar">
                <div class="MemberMenu">
                    ...
                    <div class="body">
                        <uc1:UCLeftMenu ID="UCLeftMenu1" CurrentMenuID="menu_Restaurantlist" runat="server" />
                    </div>
                    <div class="foot">
                    </div>
                </div>
                            ...
                            <asp:ListView ID="lvHireCarList" runat="server" OnPagePropertiesChanging="lvHireCarList_PagePropertiesChanging">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="member-Restaurant.aspx?seqno=<%#DataBinder.Eval(Container.DataItem,"seqno")%>">
                                                修改</a>
                                        </td>
                                    </tr>
                                </ItemTemplate>
