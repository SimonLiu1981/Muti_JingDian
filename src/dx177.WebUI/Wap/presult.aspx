<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="presult.aspx.cs" Inherits="dx177.WebUI.Wap.presult" %>
        ...
        <asp:Panel ID="Panel1" CssClass='book' runat="server">
         ...
         <asp:Panel ID="Panel2" Visible=false CssClass='book' runat="server">
             <h2>
                订单已提交</h2>
            <ul>
                <li>订单号：<span class="f_f00"> </span></li>
                <li>订单已提交，客服正在为您处理...</li>
                <li>我们将在30分钟内通过短信通知您是否预订成功。如未收到短信，您可以在线 ，或通过电话与我们联系：</li>
