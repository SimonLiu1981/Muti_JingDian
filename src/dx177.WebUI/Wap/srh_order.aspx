<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="srh_order.aspx.cs" Inherits="dx177.WebUI.Wap.srh_order" %>

<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.0//EN" "http://www.wapforum.org/DTD/xhtml-mobile10.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>订单搜索-丹霞山手机订房 - 一起去丹霞</title>
    ...
    <style type="text/css">
        body
        {
            ...
            font-size: 14px;
            color: #333;
            background: url(/wap/img/bg.gif) 0 0 repeat-x;
            line-height: 1.5;
        }
        ul, h1, h2, form
        {
        ...
        <div class="login">
            <ul>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="t_login">
                    <form action="Order_List.aspx" method="post">
                    <tr>
                        <td width="60">
                            手机号：
                        </td>
                        <td>
                            <input name="tel" type="text" format="*N" value="<%=UserPhone %>" class="input" />
                        </td>
                    </tr>
                    <tr>
                        <td>
