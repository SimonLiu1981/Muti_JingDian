<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hirecarlist.aspx.cs" Inherits="dx177.WebUI.Wap.hirecarlist" %>
    ...
    <div class="container">
        ...
        <div class="list">
            <asp:ListView ID="LsHotelList" runat="server" OnItemDataBound="LsHotelList_ItemDataBound"
                ...
                <ItemTemplate>
                    <h2>
                        <a href="hircar.aspx?seqno=<%# DataBinder.Eval(Container.DataItem, "seqno") %>"><%# DataBinder.Eval(Container.DataItem, "title")%></a></h2>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list_t">
                        <tr>
                            <td width="86" valign="top">
                                <a href="hircar.aspx?seqno=<%# DataBinder.Eval(Container.DataItem, "seqno") %>">
                                    <img style="margin-top: 4px;" src="<%# DataBinder.Eval(Container.DataItem, "logo") %>"
                                        border="0"   width="60" height="50" /></a>
                            </td>
                            <td valign="top">
                                <span class="syq">电话:<%# DataBinder.Eval(Container.DataItem, "telnumber")%><br />
                                    
                                </span><span class="jiage"><%# DataBinder.Eval(Container.DataItem, "price") %></span>元起
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
