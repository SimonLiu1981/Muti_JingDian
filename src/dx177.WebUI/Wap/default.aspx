<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="dx177.WebUI.Wap._default" %>
...
<body>
    <div class="container">
        ...
        <div class="l_top">
            <h2>
                丹霞山酒店预订(共<%=TotalCount %>家)</h2>
            <ul>
                <li>
                    <b>价格：</b>
                    <a id="Hprice0" href="<%=GetPriceUrl("0") %>" target="_self">全部</a>&nbsp;
                    <a id="Hprice100" href="<%=GetPriceUrl("100") %>" target="_self">100元以下</a> &nbsp;
                    <a href="<%=GetPriceUrl("200") %>" id="Hprice200" target="_self">100-200元</a>&nbsp;
                    <a href="<%=GetPriceUrl("300") %>" id="Hprice300" target="_self">200-300元</a>&nbsp;
                    <a href="<%=GetPriceUrl("301") %>" id="Hprice301" target="_self">300元以上</a>&nbsp;
                </li>
            </ul>
        </div>
        <div class="list">
            <asp:ListView ID="LsHotelList" runat="server" OnItemDataBound="LsHotelList_ItemDataBound"
                ...
                <ItemTemplate>
                    <h2>
                        <a href="hotel.aspx?seqno=<%# DataBinder.Eval(Container.DataItem, "seqno") %>"><%# DataBinder.Eval(Container.DataItem, "Name") %></a></h2>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list_t">
                        <tr>
                            <td width="86" valign="top">
                                <a href="hotel.aspx?seqno=<%# DataBinder.Eval(Container.DataItem, "seqno") %>">
                                    <img style="margin-top: 4px;" src="<%# DataBinder.Eval(Container.DataItem, "logo") %>"
                                        border="0" alt="<%# DataBinder.Eval(Container.DataItem, "Name") %>" width="60" height="50" /></a>
                            </td>
                            <td valign="top">
                                <span class="syq"><%#dx177.Business.DictBus.Dict.Tag["Area", DataBinder.Eval(Container.DataItem, "area").ToString(), 2052]%><br />
                                    
                                </span><span class="jiage"><%# DataBinder.Eval(Container.DataItem, "minprice") %></span>元起
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
