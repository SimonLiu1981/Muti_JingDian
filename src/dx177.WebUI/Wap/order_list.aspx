<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_list.aspx.cs" Inherits="dx177.WebUI.Wap.order_list" %>

<?xml version="1.0" encoding="utf-8" ?>
<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.0//EN" "http://www.wapforum.org/DTD/xhtml-mobile10.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>我的订单-丹霞山手机订房 - 一起去丹霞</title>
    ...
    <div class="container">
        ...
        <div class="book">
            ...
            <asp:Repeater ID="rtOrder" runat="server">
                <ItemTemplate>
                    <ul>
                        <li><%# DataBinder.Eval(Container.DataItem, "hotelname") %></li>
                        <li><span class="zt"> <%# dx177.Business.DictBus.Dict.Tag[(dx177.FrameWork.HotelOrderStatus)int.Parse(DataBinder.Eval(Container.DataItem,"status").ToString())] %></span> <a href="order_info.aspx?id=<%# DataBinder.Eval(Container.DataItem, "seqno") %>">查看详情</a></li>
                        <li class="shuoming">其它会员信息请在电脑上登录查看</li>
                    </ul>
                </ItemTemplate>
            </asp:Repeater>
        </div>
